...
def create_cli_parser():
    ...
    In order to have correct CLI syntax in the help string, the structure of the
    parser is invalid passed the first specified task group. As such, the argv
    list passed to this parser must be cleaned of all task groups beyond the
    first.
    """
